            ...
            if (option.equalsIgnoreCase("A")) {
                ...
                if (edited) {
                    if (loaded) {
                        ...
                        if (InputHelper.getYNConfirm(scan, "Do you want to save the current list before opening the new file?")) {
                        }
                    }
                }
                list.clear();
                ...
                if (loaded) {
                    ...
                    IOHelper.writeFile(list, InputHelper.getNonZeroLenString(scan, "Name your file"));
                }
                loaded = false;
                edited = false;
                saved = true;
